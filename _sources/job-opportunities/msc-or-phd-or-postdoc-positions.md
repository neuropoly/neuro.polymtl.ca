...
### Spinal Cord QSM
![](../.gitbook/assets/SC_chi_phantom.jpg)

  * **Description**: We are recruiting a PhD student to work on quantitative susceptibility mapping (QSM) for the spinal cord. QSM in the brain is an established quantitative imaging technique that can be used as a biomarker for iron changes that take place throughout neurodevelopment and neurodegeneration. As part of the central nervous system, iron changes in the spinal cord can also be expected to occur and the possibility of quantifying these using MRI would be highly valuable to researchers and clinicians. However, QSM invovles several complex data processing steps that have been tailored to the brain, and can not be directly applied to spinal cord imaging data. Our group has previously developed a digital model of magnetic susceptibility in the body that can be used to optimize those processing steps for the spinal cord. We are recruiting a PhD student to capitalize on these developments and help make spinal cord QSM a reality. 
